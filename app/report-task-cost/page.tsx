...
export default function ReportTaskCostPage() {
  ...
  const calculateTaskCost = (taskId: number): number => {
    ...
    allocation.resourceIds.forEach(resourceId => {
      ...
      if (resource) {
        // Try to parse costUse as a number
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="bg-primary text-white p-6 shadow-lg">
        ...
        <h1 className="text-3xl font-bold mt-2">Report: Total Cost for Each Task</h1>
      </div>

      <div className="container mx-auto mt-8 p-6">
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="p-6 border-b">
            <h2 className="text-xl font-semibold">Total Cost by Task (View Only)</h2>
          </div>
