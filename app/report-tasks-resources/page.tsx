  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="bg-primary text-white p-6 shadow-lg">
        ...
        <h1 className="text-3xl font-bold mt-2">Report: Tasks + Resources</h1>
      </div>

      <div className="container mx-auto mt-8 p-6">
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="p-6 border-b">
            <h2 className="text-xl font-semibold">All Tasks with Assigned Resources (View Only)</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {tasks.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="px-6 py-4 text-center text-gray-500">No tasks to display.</td>
                  </tr>
                ) : (
                  tasks.map((task) => (
                    <tr key={task.id}>
